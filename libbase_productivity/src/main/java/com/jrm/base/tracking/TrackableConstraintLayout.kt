...
/**
 * Custom ConstraintLayout that automatically tracks click events
 */
open class TrackableConstraintLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr), TrackableView {
