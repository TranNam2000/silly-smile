...
/**
 * Custom MaterialCardView that automatically tracks click events
 */
open class TrackableCardView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = com.google.android.material.R.attr.materialCardViewStyle
) : MaterialCardView(context, attrs, defStyleAttr), TrackableView {
