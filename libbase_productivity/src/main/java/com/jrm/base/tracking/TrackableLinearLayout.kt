...
/**
 * Custom LinearLayout that automatically tracks click events
 */
open class TrackableLinearLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : LinearLayout(context, attrs, defStyleAttr), TrackableView {
